...
int main() {
    ...
    printf("\n----------Movimento da Torre---------- \n\n");
    for( int torre = 0; torre < 5; torre++) //Vai execultar 5 vezes o movimeto da torre
    {
    ...
    while (bispo < 5) { //Vai execultar 5 vezes o movimeto do bispo
    ...
    do{ //Vai execultar 8 vezes o movimeto da rainha
